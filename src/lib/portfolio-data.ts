// mp4 assets — personal/influencer
import social1 from "@/assets/personal/social-1.mp4";
import social2 from "@/assets/personal/social-2.mp4";
import social3 from "@/assets/personal/social-3.mp4";
// mp4 assets — business/ads
import brand1 from "@/assets/bussines/brand-1.mp4";
import brand2 from "@/assets/bussines/brand-2.mp4";
import brand3 from "@/assets/bussines/brand-3.mp4";
// mp4 assets — restaurant/food
import motion1 from "@/assets/restaurant/duck donuts 15(1).mp4";
import motion2 from "@/assets/restaurant/fade growth media intro reel.mp4";
import motion3 from "@/assets/restaurant/duck donuts 15(1).mp4";
// mp4 assets — events
import uptalks from "@/assets/event/event-1.mp4";
import duckDonuts from "@/assets/event/event-2.mp4";
import fadeGrowth from "@/assets/event/event-3.mov";
